...
async function sendToFigma(command: string, params: any): Promise<any> {
  if (!figmaSocket || figmaSocket.readyState !== WebSocket.OPEN) {
    throw new Error(
      "Figma plugin not connected. Please open Figma and run the plugin."
    );
  }
  ...
  return {
    tools: [
      ...
      },
      {
        name: "create_input",
        description:
          "Create a styled text input field with label and placeholder in a single call",
        inputSchema: {
          type: "object",
          properties: {
            label: {
      ...
      // ============================================
      {
        ...
        description:
          "Enable auto-layout on a frame for automatic spacing and alignment",
        inputSchema: {
          type: "object",
          properties: {
            nodeId: {
            ...
            alignment: {
              ...
              enum: ["MIN", "CENTER", "MAX"],
              description:
                "Primary axis alignment (MIN=start, CENTER=center, MAX=end)",
            },
            counterAlignment: {
              type: "string",
              enum: ["MIN", "CENTER", "MAX"],
      ...
      // ============================================
      {
        ...
        description:
          "Convert a frame into a reusable component or create a new component",
        inputSchema: {
          type: "object",
          properties: {
            name: {
            ...
            fromNodeId: {
              type: "string",
              description:
                "ID of existing frame to convert to component (optional)",
            },
            width: {
              type: "number",
      ...
      // ============================================
      {
        name: "list_nodes",
        description:
          "List all nodes on the current page with their IDs and types",
        inputSchema: {
          type: "object",
          properties: {
            parentId: {
              type: "string",
              description:
                "ID of parent node to list children of (default: current page)",
            },
          },
        },
      },
